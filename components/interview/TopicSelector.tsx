...
import type { TopicOption } from '@/types/questionTypes';

type TopicSelectorProps = {
  value: TopicOption | null;
  onChange: (topic: TopicOption) => void;
};
  ...
  useEffect(() => {
    ...
    const searchTopics = async () => {
      ...
      try {
        ...
        const response = await api.get('/interviews/questions/topic/search', {
          params: {
        ...
        const mappedtopics: TopicOption[] =
